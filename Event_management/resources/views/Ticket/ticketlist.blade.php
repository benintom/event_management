                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="panel panel-default">
                                                <div class="panel-heading">List of Tickets
                                                <span class="pull-right"><a href="/ticket" class="btn btn-success btn-xs">Add ticket</a></span>
                                                </div>
                                                ...
                                                <table class="table table-striped table-dark" id="myTable">
                                                                     ...
                                                                     <th scope="row">{{$lists->id}}</th>
                                                                                            <td>{{$lists->Ticketname}}</td>  
                                                                                            <td>{{$lists->tickettype}}</td> 
                                                                                                                                                                                     
                                                                                            
                                                                                            <td>
                                                                                                <a href="/ticketedit/{{$lists->id}}" class="btn btn-success">Edit</a>
                                                                                                <a href="/ticketdelete/{{$lists->id}}" class="btn btn-danger">Delete</a>
                                                                                            </td>
                                                                                        </tr>
