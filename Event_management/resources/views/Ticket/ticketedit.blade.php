    ...
    <div class="row">
        <div class="col-md-8">
            <div class="panel panel-default">
                <div class="panel-heading"> Add Tickets</div>
                ...
                <div class="panel-body">
                    <form enctype="multipart/form-data" action="/ticketupdate/{{$ticket->id}}" method="POST">
                        <input type="hidden" name="_token" value="{{csrf_token()}}">
                      
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}"><br>
                            <label for="ticketname" class="col-md-4 control-label">Ticket Name</label>
                            <div class="col-md-6">
                            <input id="eventname" type="text" class="form-control" name="ticketname" value="{{$ticket->Ticketname}}" required autofocus>
                            </div>
                    </div> <br>
                                
                    
                         <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}"> <br>
                            <label for="Type" class="col-md-4 control-label">Event name</label>
                            <div class="col-md-6">
                                <select name="eventname" class="form-control">
                                        <option value="">--Select type--</option>
                                       @foreach ($event as $names => $value)
                     ...
                     <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">  <br>
                            <label for="Description" class="col-md-4 control-label">Ticket type</label>
                            <div class="col-md-6">
                             <input id="eventname" type="text" class="form-control" name="tickettype" value="{{$ticket->tickettype}}" required autofocus>
                            
                            </div><br> 
                    </div><br>
                    
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">  <br>
                            <label for="Seats" class="col-md-4 control-label">Quantity  </label>
                            <div class="col-md-6">
                            <input id="Seats" type="number" class="form-control" name="quantity" value="{{$ticket->quantity}}" required autofocus>
                            </div>
                    </div><br>

                     <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">  <br>
                            <label for="Seats" class="col-md-4 control-label">Rate</label>
                            <div class="col-md-6">
                            <input id="Seats" type="number" class="form-control" name="rate" value="{{$ticket->rate}}" required autofocus>
                            </div>
                    </div><br>
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">  <br>
                            <label for="Seats" class="col-md-4 control-label">Service Charge</label>
                            <div class="col-md-6">
                            <input id="Seats" type="number" class="form-control" name="charge" value="{{$ticket->servicecharge}}" required autofocus>
                            </div>
                    </div><br>
                    ...
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}"><br>
                            ...
                            <div class="col-md-6">
                            <input id="startdate" type="date" class="form-control" name="startdate" value="{{$ticket->ticketstart}}"  >
                            </div>
                    </div> <br>
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}"> <br>
                            <label for="enddate" class="col-md-4 control-label">End Date</label>
                            <div class="col-md-6"> 
                            <input id="enddate" type="date" class="form-control" name="enddate" value="{{$ticket->ticketend}}"  required autofocus>
                            </div>
                    </div> <br>
