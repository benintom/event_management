    ...
    <div class="row">
        <div class="col-md-8">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form enctype="multipart/form-data" action="/ticket/submit" method="POST">
                    ...
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}"><br>
                            ...
                            <div class="col-md-6">
                            <input id="eventname" type="text" class="form-control" name="ticketname" value="{{ old('name') }}" required autofocus>
                            </div>
                    </div> <br>
                     ...
                     <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">  <br>
                            ...
                            <div class="col-md-6">
                             <input id="eventname" type="text" class="form-control" name="tickettype" value="{{ old('name') }}" required autofocus>
                            ...
                            <div class="col-md-6">
                            <input id="Seats" type="number" class="form-control" name="quantity" value="{{ old('Seats') }}" required autofocus>
                            </div>
                    </div><br>
                     ...
                     <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">  <br>
                            ...
                            <div class="col-md-6">
                            <input id="Seats" type="number" class="form-control" name="rate" value="{{ old('Seats') }}" required autofocus>
                            </div>
                    </div><br>
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">  <br>
                            <label for="Seats" class="col-md-4 control-label">Service Charge</label>
                            <div class="col-md-6">
                            <input id="Seats" type="number" class="form-control" name="charge" value="{{ old('Seats') }}" required autofocus>
                            </div>
                    </div><br>
