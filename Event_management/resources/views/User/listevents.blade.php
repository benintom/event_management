    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="/events"><i class="fa fa-circle-o"></i> List Events</a></li>
            <li><a href="/list"><i class="fa fa-circle-o"></i> Book Events</a></li>
            ...
            <div class="row">
                @if (count($view) > 0)
                    @foreach ($view as $event)
                        <div class="col-lg-4">
                          <img src="{{$event->image}}" style="width:50%">
                            <h2><a href="{{ url('/view', $event->id) }}" class="">{{ $event->eventname}}</h2></a>
                            <div class="event-meta">
                                <div class="venue"><span class="label label-default">{{ $event->event_venue }}</span></div>
                                <div class="datetime"><span class="label label-info">{{ $event->startdate }}</span></div>
                            </div>
                            {!! $event->description !!}
                        </div>
