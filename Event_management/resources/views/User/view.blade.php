    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="/eventlist"><i class="fa fa-circle-o"></i> List Events</a></li>
            <li><a href="/eventlist"><i class="fa fa-circle-o"></i> Book Events</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="/ticket"><i class="fa fa-circle-o"></i> View Tickets</a></li>
                    ...
                    <div role="tabpanel" class="tab-pane active" id="tickets">
                      <table class="table table-bordered table-striped  ">
                        <thead>
                          <tr>
                            <td>
                              <dd><strong>{{$view->eventname}}</strong></dd>
                              <dd><img src="{{$view->image}}" alt="" width="180" height="150"></dd>
                            </td>
                            <td>
                              <dd><br><br>Venue:{{$view->event_venue}}</br></br></dd>
                            </td>
                          </tr>
                          <tr>
                            <td>
                           ...
                           <table class="table table-tickets">
                                        ...
                                        <tbody>
                                                ...
                                                <tr class="ticket-{{ $ticket->id }}">
                                                    ...
                                                    <td><strong>{{ $ticket->rate }}&nbsp;€</strong></td>
                                                    <td>
                                    ...
                                    @endif
                           <!-- <input type="submit" class="pull-right btn btn-sn btn-primary" value="Buy Ticket"> -->                                                                                           
                        </thead>
                      </table>
                    </div>
