                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="panel panel-default">
                                                ...
                                                <span class="pull-right"><a href="/events" class="btn btn-success btn-xs">Add events</a></span>
                                                </div>
                                                ...
                                                <table class="table table-striped table-dark" id="myTable">
                                                                     ...
                                                                     <th scope="row">{{$lists->id}}</th>
                                                                                            <td>{{$lists->eventname}}</td>  
                                                                                            <td>{{$lists->event_venue}}</td>                                                                                          
                                                                                            
                                                                                            <td>
                                                                                                <a href="/eventedit/{{$lists->id}}" class="btn btn-success">Edit</a>
                                                                                                <a href="/eventdelete/{{$lists->id}}" class="btn btn-danger">Delete</a>
                                                                                            </td>
                                                                                        </tr>
