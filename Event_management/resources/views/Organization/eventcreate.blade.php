    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="/eventcreate"><i class="fa fa-circle-o"></i> Add Events</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/charts/chartjs.html"><i class="fa fa-circle-o"></i> Add Tickets</a></li>
            <li><a href="pages/charts/morris.html"><i class="fa fa-circle-o"></i> List Tickets</a></li>
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form enctype="multipart/form-data" action="/events/submit" method="POST">
                    ...
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}"><br>
                            ...
                            <div class="col-md-6">
                            <input id="eventname" type="text" class="form-control" name="eventname" value="{{ old('name') }}" required autofocus>
                            </div>
                    </div> <br>
                                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                                            <label for="fname" class="col-md-4 control-label">Event Image</label>
                                                            <div class="col-md-6">
                                                            <input id="fname" type="file" class="form-control" name="image" value="{{ old('event') }}" required autofocus>
                                                            </div>
                                                    </div>
                                                    </br>
                                                  <br>
                     ...
                     <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">  <br>
                            ...
                            <textarea name="Description" rows="3" cols="43" value="{{ old('Description') }}" required autofocus>  </textarea> 
                            </div><br> 
                    </div><br>
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">  <br>
                            <label for="Venue" class="col-md-4 control-label">Event Venue</label>
                            <div class="col-md-6">
                            <input id="Venue" type="text" class="form-control" name="Venue" value="{{ old('Venues') }}" required autofocus>
                            </div>
                    </div><br>
                    ...
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}"> <br>
                            ...
                            <div class="col-md-6"> 
                            <input id="enddate" type="date" class="form-control" name="enddate" value="{{ old('slug') }}" required autofocus>
                            </div>
                    </div> <br>
                    ...
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">  <br>
                            ...
                            <div class="col-md-6">
                            <input id="starttime" type="time" class="form-control" name="starttime" value="{{ old('Venues') }}" required autofocus>
                            </div>
                    </div><br>
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">  <br>
                            <label for="endtime" class="col-md-4 control-label">End Time</label>
                            <div class="col-md-6">
                            <input id="endtime" type="time" class="form-control" name="endtime" value="{{ old('Seats') }}" required autofocus>
                            </div>
                    </div><br>
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">  <br>
                            <label for="Seats" class="col-md-4 control-label">Seats</label>
                            <div class="col-md-6">
                            <input id="Seats" type="number" class="form-control" name="Seats" value="{{ old('Seats') }}" required autofocus>
                            </div>
                    </div><br>
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}"> <br>
                    ...
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}"><br>
                            ...
                            <div class="col-md-6">
                                <input id="eventtopic" type="text" class="form-control" name="topic" value="{{ old('name') }}" required autofocus>
                    ...
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">  <br>
                            ...
                            <textarea name="Instructions" rows="3" cols="43" value="{{ old('Instructions') }}" required autofocus>  </textarea> 
                            </div><br> 
                    </div><br>
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">  <br>
                            <label for="Conditions" class="col-md-4 control-label">Terms And Conditions</label>
                            <div class="col-md-6">
                                <textarea name="Conditions" rows="3" cols="43"></textarea>
