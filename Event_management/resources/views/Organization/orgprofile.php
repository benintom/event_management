      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="/upload/avatar/{{$user->avatar}}" class="user-image" alt="User Image">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/layout/top-nav.html"><i class="fa fa-circle-o"></i> Add Events</a></li>
            <li><a href="pages/layout/boxed.html"><i class="fa fa-circle-o"></i> List  Events</a></li>
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="panel panel-default">
                ...
                <div>
                <div class="panel-body">
                    <form enctype="multipart/form-data" action="/test/submit" method="POST">
                    ...
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                     ...
                     <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                            <input id="logo" type="file" class="form-control" name="image" >
                            </div>
                    </div>
                     <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                    ...
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                            <input id="website" type="text" class="form-control" name="website" value="{{ old('phone') }}" required autofocus>
                            </div>
                    </div>
